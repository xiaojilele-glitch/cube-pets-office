...
export default function LineagePage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100vh", background: "#f9fafb" }}>
      ...
      >
        <span style={{ fontWeight: 600, fontSize: 15, color: "#111827", marginRight: 8 }}>
          Data Lineage
        </span>
        ...
        <input
          ...
          style={{ fontSize: 12, padding: "4px 8px", borderRadius: 4, border: "1px solid #d1d5db", width: 120 }}
        />
        ...
        <input
          ...
          style={{ fontSize: 12, padding: "4px 8px", borderRadius: 4, border: "1px solid #d1d5db", width: 140 }}
        />
