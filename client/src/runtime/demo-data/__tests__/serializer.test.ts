...
function makeValidBundleObj() {
  return {
    ...
    workflow: { id: "w1", directive: "d", status: "completed", current_stage: null, departments_involved: [], started_at: null, completed_at: null, results: null, created_at: new Date().toISOString() },
    agents: [{ id: "a1", name: "Agent1", department: "d1", role: "ceo", manager_id: null, model: "gpt-4", soul_md: null, heartbeat_config: null, is_active: 1, created_at: new Date().toISOString(), updated_at: new Date().toISOString() }],
    messages: [],
    tasks: [],
    memoryEntries: [],
    evolutionLogs: [],
