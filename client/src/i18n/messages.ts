  ...
  'zh-CN': {
    ...
    tasks: {
      listPage: {
        ...
        refresh: '刷新',
        queueTitle: '执行队列',
        visibleCount: (visible: number, total: number) => `${visible} 条可见 / 共 ${total} 条`,
        searchPlaceholder: '搜索标题、阶段、信号、部门...',
        emptyTitle: '当前没有任务',
        emptyDescription: '在这里新建任务，或等待运行时派发新的执行项；队列会自动刷新。',
        warnings: '需关注',
        noStage: '尚未进入阶段',
      ...
      detailPage: {
        eyebrow: '执行详情',
        description: '查看当前负责人、阻塞项、下一步动作、时间线、决策与交付物。',
        replay: '查看回放',
        back: '返回',
      },
      createDialog: {
        title: '新建任务',
        description: '直接通过 Worktree A 的任务 API 创建任务，并在执行工作台中打开。',
        titleLabel: '标题',
      ...
      emptyState: {
        selectTitle: '选择一个任务',
        selectDescription: '从左侧队列选择任务，查看执行摘要、内部状态、时间线、交付物与决策入口。',
      },
      hero: {
        updated: '最近更新',
        recommended: '建议优先操作',
      ...
      operatorBar: {
        ...
        blockTitle: '将任务标记为阻塞？',
        blockDescription: '这不会结束任务，只会把当前状态标记为阻塞，方便团队知道需要先解决什么。',
  ...
  'en-US': {
    ...
    workflow: {
      ...
      directive: {
        ...
        steps: [
          ['1. Frame the work', 'Identify the goal, risk, dependencies, and expertise that the task really needs.'],
          ['2. Set up the team', 'Stand up the best-fit execution roles for this ask instead of reusing fixed staffing.'],
          ['3. Attach capabilities', 'Bind the right skills, MCP tools, model choices, and tool access to each role.'],
          ['4. Publish the brief', 'Turn the ask into explicit ownership, boundaries, and delivery expectations.'],
          ['5. Drive parallel delivery', 'Independent roles move at the same time and only serialize on real dependencies.'],
          ['6. Review with owners', 'Leads consolidate output and check completeness, quality, and actionability.'],
          ['7. Audit quality', 'Review boundary drift, weak evidence, and output quality across the run.'],
          ['8. Close revisions', 'Anything below the bar loops until it is ready to ship.'],
          ['9. Hand off delivery', 'Roles summarize first, then the final output is assembled for delivery.'],
          ['10. Reuse the learning', 'Store the team pattern and lessons so the next run starts sharper.'],
        ],
        placeholder: 'Enter an execution goal and use the attached files as context...',
    ...
    tasks: {
      listPage: {
        ...
        description: 'See the current execution, owner, blocker, next step, and delivery progress first.',
        create: 'New Mission',
        refresh: 'Refresh',
        queueTitle: 'Execution Queue',
        visibleCount: (visible: number, total: number) => `${visible} visible / ${total} total`,
        searchPlaceholder: 'Search titles, stages, signals, departments...',
        emptyTitle: 'No missions yet',
        emptyDescription: 'Create a mission here or wait for the runtime to dispatch one, and it will appear in this queue automatically.',
      ...
      detailPage: {
        ...
        description: 'Review the current owner, blocker, next action, timeline, decisions, and deliverables.',
        replay: 'View Replay',
        back: 'Back',
      },
      createDialog: {
        title: 'New Mission',
        description: 'Create a mission directly from the Worktree A task API and open it in the execution workspace.',
        titleLabel: 'Title',
        titlePlaceholder: 'Short mission title',
        sourceLabel: 'Mission brief',
        sourcePlaceholder: 'Describe the mission request, constraints, and expected deliverable.',
        kindLabel: 'Kind',
        kindPlaceholder: 'chat',
      ...
      emptyState: {
        ...
        selectDescription: 'Pick a mission from the queue to inspect its execution summary, runtime state, timeline, artifacts, and decision entry.',
      },
      hero: {
      ...
      operatorBar: {
        ...
        blockDescription: 'This does not end the mission. It marks the current state as blocked so the team can see what follow-up is needed.',
        ...
        terminateDescription: 'This reuses the cancel flow and will move the mission into a terminal cancelled state.',
      ...
      detailView: {
        ...
        workPackagesDescription: 'Execution output, review loops, revisions, and score snapshots.',
        workPackagesEmpty: 'This mission has not emitted any delivery lanes yet.',
        timelineTitle: 'Execution Timeline',
        timelineDescription: 'Mission events, state transitions, and the latest coordination signals.',
        ...
        decisionEntryFallback: 'Submit the current mission decision and continue execution.',
        decisionNotePlaceholder:
          'Optional decision note: add confirmation detail, constraints, or the exact follow-up the mission should respect.',
        decisionStructuredOnly: 'This mission uses structured decision options only.',
        decisionTerminal: 'This mission is already in a terminal state, so no further execution decisions are available.',
        decisionIdle: 'This mission is not currently waiting for a decision.',
        runtimeSnapshotTitle: 'Runtime Snapshot',
        runtimeSnapshotDescription: 'Compact preview of instance facts and runtime metrics.',
        runtimeSnapshotDetailsTitle: 'Runtime Snapshot Details',
        runtimeSnapshotDetailsDescription: 'Full instance info and log summary.',
        runtimeSnapshotDetailsButton: 'More details',
        artifactsTitle: 'Deliverables',
        artifactsDescription: 'Mission reports, department summaries, and input attachments.',
        ...
        decisionHistoryDescription: "Past decisions made during this mission's execution.",
