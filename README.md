...
| 自然语言指挥中心 | ✅ |
| 3D 场景 Mission 状态融合 | ✅ |
| 导出为 CrewAI / LangGraph / AutoGen 格式 | ✅ |
| 预录演示数据引擎 + 引导体验 | ✅ |
| 飞书集成 | ✅ |
| 中英文切换 / 移动端适配 | ✅ |
| 结构化报告输出 + 下载 | ✅ |
...
| 前端 | React 19、Vite、TypeScript、Zustand、Recharts |
...
| 功能模块 (specs) | 38 个，已完成 29 个 |
| Commits | 212+ |

## 项目结构

```
client/     前端应用、3D 场景、工作流面板、任务页面、治理面板
server/     Express API、工作流引擎、动态组织、记忆系统、治理引擎
shared/     共享类型、契约定义（8 个契约模块 + 业务类型）
services/   Lobster 执行器（Docker 参考实现）
