...
<p align="center">
  ...
  <img alt="specs" src="https://img.shields.io/badge/specs-56%20tracked-0ea5e9" />
  <img alt="status" src="https://img.shields.io/badge/status-39%20done%20%C2%B7%208%20partial-22c55e" />
...
下图按 2026-04-11 的项目快照更新：主干仍是前端 / Cube Brain / Intelligence / Trust / Execution / Interop 六层，但前端侧已经明确纳入可操作任务控制台、产物预览下载、执行器回传与状态操作闭环。
...
| `.kiro/specs` | **56 个目录：39 已完成 / 8 部分完成 / 9 未开始** |
| 共享契约 | **14 个 `shared/**/contracts.ts` 模块** |
| 测试覆盖 | **300+ 测试文件（Vitest + fast-check）** |
| 当前活跃增量 | `workflow-artifacts-display` 最终验收 + `i18n-cleanup` 收口 + 工程基线欠账治理 |
| Commits | 280+ |
