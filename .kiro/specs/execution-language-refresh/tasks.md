...
- [x] 1. 盘点任务相关核心文案
  - [x] 1.1 搜集 `WorkflowPanel`、`TasksPage`、`TaskDetailView`、`TaskDetailPage`、`messages.ts` 中的相关文案
  - [x] 1.2 标记硬编码与 i18n 文案来源
  - [x] 1.3 形成术语替换清单
    - _Requirements: 1.1.1, 4.1.1_

- [x] 2. 建立统一术语映射
  - [x] 2.1 在 spec 或注释中整理中英文映射表
  - [x] 2.2 优先确定任务、执行、协作、交付、阻塞、下一步等高频术语
    - _Requirements: 1.1.2, 1.1.3, 5.1.1, 5.1.2_

- [x] 3. 更新 i18n 文案
  - [x] 3.1 修改 `client/src/i18n/messages.ts`
    - Workflow 相关标题
    - Task 页相关标题
    - 按钮文案
    - 空态 / 错误态
