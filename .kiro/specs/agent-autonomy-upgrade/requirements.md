...
2. WHEN Agent 通过粗筛后，THE SelfAssessment*Module SHALL 计算 fitnessScore，公式为：fitness = w1 * skillMatch + w2 _ (1 - loadFactor) + w3 _ confidenceScore + w4 \_ resourceAdequacy，默认权重 w1=0.4, w2=0.2, w3=0.25, w4=0.15，权重可通过配置中心动态调整
