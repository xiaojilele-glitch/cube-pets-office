...
- [ ] 1. 共享类型定义
  - [ ] 1.1 创建 `shared/cost-governance.ts`，定义所有成本治理相关 TypeScript 类型
...
- [ ] 2. 审计链模块
  - [ ] 2.1 创建 `server/core/governance/audit-trail.ts`，实现 AuditTrail 类
...
- [ ] 3. 预算管理模块
  - [ ] 3.1 创建 `server/core/governance/budget-manager.ts`，实现 BudgetManager 类
...
- [ ] 4. 告警管理模块
  - [ ] 4.1 创建 `server/core/governance/alert-manager.ts`，实现 AlertManager 类
...
- [ ] 6. 模型降级管理模块
  - [ ] 6.1 创建 `server/core/governance/downgrade-manager.ts`，实现 ModelDowngradeManager 类
