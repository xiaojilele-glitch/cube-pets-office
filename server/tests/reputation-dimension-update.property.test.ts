    ...
    fc.assert(
      fc.property(
        ...
        (dims, signal, streak) => {
          ...
          const speedRatio =
            signal.actualDurationMs / signal.estimatedDurationMs;
    ...
    fc.assert(
      fc.property(
        ...
        (dims, signal, streak) => {
          ...
          expectedReliabilityDelta -=
            signal.downstreamFailures *
            config.reliability.downstreamFailurePenalty;
