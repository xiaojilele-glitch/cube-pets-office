...
const roleIdArb = fc.constantFrom('coder', 'reviewer', 'lead', 'tester', 'architect');
    ...
    fc.assert(
      fc.property(
        ...
        (signalTemplate) => {
          ...
          const overallQualityDelta = profileAfter.dimensions.qualityScore - dimsBefore.qualityScore;
          const overallSpeedDelta = profileAfter.dimensions.speedScore - dimsBefore.speedScore;
          const overallEfficiencyDelta = profileAfter.dimensions.efficiencyScore - dimsBefore.efficiencyScore;
          const overallCollabDelta = profileAfter.dimensions.collaborationScore - dimsBefore.collaborationScore;
          const overallReliabilityDelta = profileAfter.dimensions.reliabilityScore - dimsBefore.reliabilityScore;
          ...
          const roleEfficiencyDelta = roleAfter!.dimensions.efficiencyScore - initScore;
          const roleCollabDelta = roleAfter!.dimensions.collaborationScore - initScore;
          const roleReliabilityDelta = roleAfter!.dimensions.reliabilityScore - initScore;
