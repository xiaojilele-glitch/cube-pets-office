...
const TEST_TEMPLATE_PATH = resolve(
  __test_dirname,
  "../../../data/__test_nl_templates__/nl-templates.json"
);
...
function makePlan(overrides: Partial<NLExecutionPlan> = {}): NLExecutionPlan {
  return {
    ...
    timeline: overrides.timeline ?? {
      ...
      criticalPath: ["m1"],
      milestones: [
        { id: "ms1", label: "Start", date: "2026-01-01", entityId: "m1" },
      ],
      entries: [
        {
          entityId: "m1",
...
describe("TemplateManager", () => {
  ...
  describe("update()", () => {
    ...
    it("should throw for non-existent templateId", () => {
      expect(() =>
        manager.update("nonexistent", makePlan(), "desc", "user-1")
