...
function makePlan(): NLExecutionPlan {
  return {
    ...
    costBudget: { totalBudget: 0, missionCosts: {}, taskCosts: {}, agentCosts: {}, modelCosts: {}, currency: 'USD' },
...
describe('NLCommandSocketEmitter', () => {
  ...
  it('all payloads include issuedAt as a recent timestamp', () => {
    ...
    emitter.emitAlert({
      alertId: 'a', type: 'ERROR_OCCURRED', priority: 'info',
      message: 'x', entityId: 'e', entityType: 'task',
      triggeredAt: 0, acknowledged: false,
    });
