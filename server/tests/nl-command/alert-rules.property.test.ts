...
const TEST_AUDIT_PATH = resolve(
  __test_dirname,
  "../../../data/__test_alert_rules_prop__/nl-audit.json"
);
...
const operatorArb = fc.constantFrom<AlertCondition["operator"]>(
  "gt",
  "lt",
  "eq",
  "gte",
...
const priorityArb = fc.constantFrom<AlertPriority>(
  "critical",
  "warning",
  "info"
);
